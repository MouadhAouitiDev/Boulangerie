...
= 0.2 =
* Done minor changeds in readme file.
* Added Post format.
* Changed Style.css
...
* Resolved escaped errors from color-option.php.
* Done prefixing in customizer.php.
* Changed focus css.
...
= 0.5.4 =
* Done Escaping.
* Removed unusable css from style.css.

== Resources ==

Tanawul Bakery WordPress Theme, Copyright 2019 ThemesEye
Tanawul Bakery is distributed under the terms of the GNU GPL
...
Tanawul Bakery WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
Twenty Seventeen WordPress Theme is distributed under the terms of the GNU GPL

Tanawul Bakery bundles the following third-party resources:
...
** Stocksnap Images 
    ...
    Slider Image, Copyright Brooke Lark
    License: CC0 1.0 Universal (CC0 1.0)
