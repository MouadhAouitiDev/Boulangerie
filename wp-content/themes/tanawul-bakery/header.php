									...
									<div class="row">
										<div class="col-lg-4 col-md-5">
											<?php if( get_theme_mod( 'tanawul_bakery_contact_number','' ) != '') { ?>
								                <a class="call" href="tel:<?php echo esc_attr( get_theme_mod('tanawul_bakery_contact_number','' )); ?>"><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('tanawul_bakery_contact_number','' )); ?><span class="screen-reader-text"><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('tanawul_bakery_contact_number','' )); ?></span></a>
								            <?php } ?>
								        </div>
								        <div class="col-lg-8 col-md-7">
											<?php if( get_theme_mod( 'tanawul_bakery_email_address','' ) != '') { ?>
								                <a class="email" href="mailto:<?php echo esc_attr( get_theme_mod('tanawul_bakery_email_address','') ); ?>"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('tanawul_bakery_email_address','') ); ?><span class="screen-reader-text"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_html( get_theme_mod('tanawul_bakery_email_address','') ); ?></span></a>
								            <?php } ?>
								        </div>
							        </div>
						        </div>
